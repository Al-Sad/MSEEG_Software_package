...
%% Parameters
per = 0.65;   % Causality plotting threshold
...
for m = 1:M
    ...
    % Loading Real EEG
    load(['Patient_' num2str(m) '_synch.mat'],'CB','CS','Channel_label');
    % Averaging
...
if(opt == 'y' || opt == 'Y')
    print(1,'real_synchrony_back','-dpdf','-r400');
    print(2,'real_synchrony_seiz','-dpdf','-r400');
else
    return
end
