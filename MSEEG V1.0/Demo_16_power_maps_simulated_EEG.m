...
set(gca,'yticklabel',Channel_label,'Ytick',1:20,'xticklabel','','fontweight','bold','fontsize',16,'FontName','Times');
...
figure('Color',[1,1,1],'Position',[100 0 800 700]);
subplot(10,1,1:9)
imagesc(10*log10(P_sim)); axis xy; colormap jet; xlim([1 N]);
...
if(opt == 'y' || opt == 'Y')
    print(1,'real_power_map_cmp','-dpdf','-r400');
    print(2,'simulated_power_map','-dpdf','-r400');
end