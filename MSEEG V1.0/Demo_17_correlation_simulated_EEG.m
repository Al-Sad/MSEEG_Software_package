...
%% Parameters
per  = 0.31;  % Correlation plotting threshold
...
for m = 1:M
    ...
    % Loading Real EEG
    load(['simulated_EEG_' num2str(m) '_corr.mat'],'CB_t','CS_t','CB_tf','CS_tf','Channel_label');
    % Averaging
...
if(opt == 'y' || opt == 'Y')
    print(1,'sim_corr_tf_back','-dpdf','-r400');
    print(2,'sim_corr_tf_seiz','-dpdf','-r400');
else
    return
end