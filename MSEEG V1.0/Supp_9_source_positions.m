...
for m = 1:M
    ...
    if(opt == 'y' || opt == 'Y')
        print(1,['seizure_source_positions_' num2str(m) '_xy'],'-dpdf','-opengl','-r400');
        print(2,['seizure_source_positions_' num2str(m) '_yz'],'-dpdf','-opengl','-r400');
        print(3,['seizure_source_positions_' num2str(m) '_xz'],'-dpdf','-opengl','-r400');
        print(4,['backrgound_source_positions_' num2str(m) '_xy'],'-dpdf','-opengl','-r400');
        print(5,['backrgound_source_positions_' num2str(m) '_yz'],'-dpdf','-opengl','-r400');
        print(6,['backrgound_source_positions_' num2str(m) '_xz'],'-dpdf','-opengl','-r400');
        close all;
    end
end
